...
export const habitFeatures = createSlice({
	name: "habit",
	initialState,
...
console.log(habitFeatures);

// exporting the reducers [functions]
export const { addHabit, deleteHabit, updateStatus } = habitFeatures.actions;

export default habitFeatures.reducer;
